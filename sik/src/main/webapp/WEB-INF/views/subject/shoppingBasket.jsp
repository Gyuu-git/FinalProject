		 ...
		 $("#colleage").on("change",function(){
			...
			if(colleage=="전체"){
				...
				$.ajax({
			  		...
			  		type : "post",
			  		success : function(result){
// 			  			alert("result.departmentVOList[0].deptNm : "+result.departmentVOList[0].deptNm);
			  			var str ="";
...
// 			alert("colleage : "+colleage + ", department : "+department+" , keyword : "+keyword);
			...
			$.ajax({
		  		...
		  		success : function(result){
// 		  			alert("result : "+result.subjectList.content.length);
