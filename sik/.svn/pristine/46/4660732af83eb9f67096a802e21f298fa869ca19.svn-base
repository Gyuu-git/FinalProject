...
<!--               <p class="mb-4">Please sign-in to your account and start the adventure</p> -->
              ...
              <form id="formAuthentication" class="mb-3" action="/login" method="post">
                <div class="row" >
			    	<div class="col-4"><button class="btn rounded-pill btn-outline-info btn-sm d-grid w-100 " type="submit">학생</button></div>
			    	<div class="col-4"><button class="btn rounded-pill btn-outline-warning btn-sm d-grid w-100 " type="submit">교수</button></div>
			    	<div class="col-4"><button class="btn rounded-pill btn-outline-success btn-sm d-grid w-100 " type="submit">교직원</button></div>
			    </div>
			    <br/>
                <div class="mb-3">
